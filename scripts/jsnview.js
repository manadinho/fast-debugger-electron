    ...
    return (()=>{
                ...
                e.exports = function(e) {
                    ...
                    n.i = function(e, t, r, o, i) {
                        ...
                        for (var l = 0; l < e.length; l++) {
                            var d = [].concat(e[l]);
                            r && a[d[0]] || (void 0 !== i && (void 0 === d[5] || (d[1] = "@layer".concat(d[5].length > 0 ? " ".concat(d[5]) : "", " {").concat(d[1], "}")),
                            d[5] = i),
        ...
        return (()=>{
            ...
            function A(e, n) {
                const t = function() {
                    const e = m("div");
                    e.innerHTML+='<div class="logo-section"> <img src="../../images/javascript.svg" width="20px" height="auto" alt=""><span>JAVASCRIPT</span></div>';
                    return e.className = "json-container",
                    e
                }();
                L(e, (function(e) {
                    e.el = function(e) {
                        ...
                        return null !== e.parent && r.classList.add(x),
